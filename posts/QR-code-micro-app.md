...
YEAR 1
- Network Fundamentals (Cisco CCNA1)
- Computer Programming (Python)
- Applied Operating Systems (Linux, AWS & LAMP stacks)
- Computer Systems (Basic Electronics, Computer Architecture, Combinational Logic)
- Mathematics for Computing 
- Computer Forensics Fundamentals (WinHex, FTK Imager, & File Systems)

YEAR 2
- Cyber Security Operations (Cisco Cyber Operations Associate: CBROPS 200-201)
- System Security Attacks and Defences (ACLs)
- Digital Forensics Tools & Techniques (FTK Registry Viewer, & PowerShell)
- Networking Technologies (Cisco CCNA2)
- Software Security (Software Pentesting)
- English Legal System & IT Law
 
YEAR 3
- Advanced Cyber Security Operations (Cisco Cyber Operations Associate: CBROPS 200-201)
- Network and Internet Forensics (Autopsy, Wireshark & Data Recovery)
- Ethical Hacking (EC-Council)
- Cloud Computing (AWS)
- Individual Honours Project "Raspberry Pi-based Remote IoT Pentesting Platform"
